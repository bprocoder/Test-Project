...
from .views import compafterdays
...
def compafterdays_task():#(self) cron task executed here to renew open order for the next day that have been cancelled due to market close
