    ...
    init: function() {
        ! function() {
            ...
            if (e) {
                ...
                i("#E4E6EF", t.lineWidth, 1), i(KTUtil.getCssVariableValue("--kt-primary"), t.lineWidth, 100 / 150), i(KTUtil.getCssVariableValue("--kt-success"), t.lineWidth, .4)
            }
        }()
    }
};
...
var data = [{
  ...
  orders: getOrdersband()
}, {
  service: "Greeting Messages",
  orders: getOrdersgm()
},{
	service: "Video Chat",
	orders: getOrdersvc()
...
{
  service: "Shoutout",
  orders: getOrdersshout()
},
{
  service: "Influencer Acquisition",
  orders: getOrdersinfoacq()
  }];
...
function getOrdersgm(){
    // Implement your logic here to retrieve dynamic data for Completed Orders
    // Return the array of data for Completed Orders
    var myElement1 = document.getElementById('myElement2');
    var myVariable1 = myElement1.dataset.myVariable;
    return  myVariable1;
}
...
function getOrdersvc(){
    // Implement your logic here to retrieve dynamic data for Completed Orders
    // Return the array of data for Completed Orders
    var myElement1 = document.getElementById('myElement3');
    var myVariable1 = myElement1.dataset.myVariable;
    return  myVariable1;
}


function getOrdersshout(){
    // Implement your logic here to retrieve dynamic data for Completed Orders
    // Return the array of data for Completed Orders
    var myElement1 = document.getElementById('myElement4');
    var myVariable1 = myElement1.dataset.myVariable;
    var myElement2 = document.getElementById('myElement5');
    var myVariable2 = myElement2.dataset.myVariable;
    var myvariable3=myVariable1+myVariable2;
    return  myvariable3;
}


function getOrdersinfoacq(){
    // Implement your logic here to retrieve dynamic data for Completed Orders
    // Return the array of data for Completed Orders
    var myElement1 = document.getElementById('myElement6');
    var myVariable1 = myElement1.dataset.myVariable;
    return  myVariable1;
}
...
var root = am5.Root.new("kt_card_widget_17_chart");
...
{
  service: "Shoutout",
  sales: getRevenueshout()
},
{
  service: "Influencer Acquisition",
  sales: getRevenueinfoacq()
  }];
...
function getRevenueband(){
    // Implement your logic here to retrieve dynamic data for Completed Orders
    // Return the array of data for Completed Orders
    var myElement1 = document.getElementById('myElement7');
    var myVariable1 = myElement1.dataset.myVariable;
    console.log(myVariable1);
    return  myVariable1;
}
...
function getRevenuegm(){
    // Implement your logic here to retrieve dynamic data for Completed Orders
    // Return the array of data for Completed Orders
    var myElement1 = document.getElementById('myElement8');
    var myVariable1 = myElement1.dataset.myVariable;
    return  myVariable1;
}
...
function getRevenuevc(){
    // Implement your logic here to retrieve dynamic data for Completed Orders
    // Return the array of data for Completed Orders
    var myElement1 = document.getElementById('myElement9');
    var myVariable1 = myElement1.dataset.myVariable;
    return  myVariable1;
}


function getRevenueshout(){
    // Implement your logic here to retrieve dynamic data for Completed Orders
    // Return the array of data for Completed Orders
    var myElement1 = document.getElementById('myElement10');
    var myVariable1 = myElement1.dataset.myVariable;
    var myElement2 = document.getElementById('myElement11');
    var myVariable2 = myElement2.dataset.myVariable;
    var myvariable3=myVariable1+myVariable2;
    return  myvariable3;
}
...
function getRevenueinfoacq(){
    // Implement your logic here to retrieve dynamic data for Completed Orders
    // Return the array of data for Completed Orders
    var myElement1 = document.getElementById('myElement12');
    var myVariable1 = myElement1.dataset.myVariable;
    return  myVariable1;
}
    ...
    init: function() {
        ! function() {
            ...
            if (e) {
                ...
                i("#E4E6EF", t.lineWidth, 1), i(KTUtil.getCssVariableValue("--kt-danger"), t.lineWidth, 100 / 150), i(KTUtil.getCssVariableValue("--kt-primary"), t.lineWidth, .4)
            }
        }()
    }
};
    ...
    return {
        init: function() {
            ...
            l(a, "#kt_charts_widget_11_tab_3", "#kt_charts_widget_11_chart_3", i, !0), KTThemeMode.on("kt.thememode.change", (function() {
                e.rendered && e.self.destroy(), t.rendered && t.self.destroy(), a.rendered && a.self.destroy(), l(e, "#kt_charts_widget_11_tab_1", "#kt_charts_widget_11_chart_1", r, e.rendered), l(t, "#kt_charts_widget_11_tab_2", "#kt_charts_widget_11_chart_2", o, t.rendered), l(a, "#kt_charts_widget_11_tab_3", "#kt_charts_widget_11_chart_3", i, a.rendered)
            }))
        }
    }
}();
                ...
                if (e) {
                    var t, a = function() {
                        ...
                        o.get("renderer").grid.template.setAll({
                            ...
                            fontSize: 13,
                            fill: am5.color(KTUtil.getCssVariableValue("--kt-gray-500"))
                        }), i("Cars", "cars", KTUtil.getCssVariableValue("--kt-primary")), i("Motorcycles", "motorcycles", KTUtil.getCssVariableValue("--kt-success")), i("Bicycles", "bicycles", KTUtil.getCssVariableValue("--kt-warning")), a.set("scrollbarX", am5.Scrollbar.new(t, {
                ...
                if (e) {
                    var t, a = function() {
                        ...
                        var i = am5xy.AxisRendererY.new(t, {
                            ...
                            s = a.yAxes.push(am5xy.ValueAxis.new(t, {
                                renderer: i,
                                min: 0,
                                max: 100,
                                strictMinMax: !0
...
var KTChartsWidget19 = {
    init: function() {
        ...
        function() {
            if ("undefined" != typeof am5) {
                var e, t = document.getElementById("kt_charts_widget_19_chart_2");
                if (t) {
                    var a = function() {
                ...
                if (e) {
                    var t, a = function() {
                        ...
                        var i = o.children.push(am5xy.XYChart.new(t, {
                            ...
                            s = i.yAxes.push(am5xy.CategoryAxis.new(t, {
                                categoryField: "age",
                                renderer: am5xy.AxisRendererY.new(t, {})
                            }));
                        s.get("renderer").labels.template.setAll({
                        ...
                        var f, u = g.children.push(am5.Label.new(t, {
                                text: "United States",
                                fontSize: 14,
                                fontWeight: "500",
                            ...
                            p = g.series.push(am5map.MapPolygonSeries.new(t, {
                ...
                if (e) {
                    var t, a = function() {
                        ...
                        var r = a.xAxes.push(am5xy.CategoryAxis.new(t, {
                            ...
                            i = a.yAxes.push(am5xy.ValueAxis.new(t, {
                                renderer: o
                            }));
                        o.grid.template.setAll({
                            strokeDasharray: [2, 2],
    ...
    init: function() {
        ! function() {
            if ("undefined" != typeof am5) {
                ...
                if (e) {
                    var t, a, l = function() {
                        (a = am5.Root.new(e)).setThemes([am5themes_Animated.new(a)]), (t = a.container.children.push(am5radar.RadarChart.new(a, {
                            panX: !1,
                            panY: !1,
                            wheelX: "panX",
                            wheelY: "zoomX",
                            ...
                            radius: am5.percent(70),
                            arrangeTooltips: !1
                        }))).set("cursor", am5radar.RadarCursor.new(a, {
                            behavior: "zoomX"
                        })).lineY.set("visible", !1);
    ...
    return {
        init: function() {
            ...
            l(a, "#kt_charts_widget_32_tab_3", "#kt_charts_widget_32_chart_3", i, !1), KTThemeMode.on("kt.thememode.change", (function() {
                e.rendered && e.self.destroy(), t.rendered && t.self.destroy(), a.rendered && a.self.destroy(), l(e, "#kt_charts_widget_32_tab_1", "#kt_charts_widget_32_chart_1", r, e.rendered), l(t, "#kt_charts_widget_32_tab_2", "#kt_charts_widget_32_chart_2", o, t.rendered), l(a, "#kt_charts_widget_32_tab_3", "#kt_charts_widget_32_chart_3", i, a.rendered)
            }))
        }
    }
}();
    ...
    return {
        init: function() {
            ...
            var u = [3e3, 2100, 3200, 3200, 1800, 1800, 2400, 2400, 3100, 3100, 2400, 2400, 3e3, 2400, 2800],
                p = ["Sep 2021", "Oct 2021", "Nov 2021", "Dec 2021", "Jan 2022", "Feb 2022", "Mar 2022", "Apr 2022", "May 2022", "Jun 2022", "Jul 2022", "Aug 2022", "Sep 2022", "Oct 2022", "Nov 2022"];
            o(r, "#kt_charts_widget_34_tab_5", "#kt_charts_widget_34_chart_5", u, p, !1), KTThemeMode.on("kt.thememode.change", (function() {
                e.rendered && e.self.destroy(), t.rendered && t.self.destroy(), a.rendered && a.self.destroy(), l.rendered && l.self.destroy(), r.rendered && r.self.destroy(), o(e, "#kt_charts_widget_34_tab_1", "#kt_charts_widget_34_chart_1", i, s, e.rendered), o(t, "#kt_charts_widget_34_tab_2", "#kt_charts_widget_34_chart_2", n, d, t.rendered), o(a, "#kt_charts_widget_34_tab_3", "#kt_charts_widget_34_chart_3", m, c, a.rendered), o(l, "#kt_charts_widget_34_tab_4", "#kt_charts_widget_34_chart_4", g, f, l.rendered), o(r, "#kt_charts_widget_34_tab_5", "#kt_charts_widget_34_chart_5", u, p, r.rendered)
            }))
        }
    }
}();
...
var KTChartsWidget35 = function() {
    var e = {
        ...
        o = function(e, t, a, l, r, o) {
            ...
            var cmsales=window.cysales;

            var smallestValue = Math.min.apply(null, cmsales);
            var largestValue = Math.max.apply(null, cmsales);
    ...
    return {
        init: function() {
            var i = [2100, 3100, 3100, 2400, 2400, 1800, 1800, 2400, 2400, 3200, 3200, 2800, 2100, 3100, 3100, 2400, 2400, 1800, 1800, 2400, 2400, 3200, 3200, 2800,],
                s = ["1AM", "2AM", "3AM", "4AM", "5AM", "6AM", "7AM", "8AM", "9AM", "10AM", "11AM", "12PM", "1PM", "2PM", "3PM", "4PM", "5PM", "6PM", "7PM", "8PM", "9PM", "10PM", "11PM", "12AM",];
              
            
            var cdsal = window.cdsales;
            var cdtime=window.cdtime;
            ...
            var m = [2900, 3400, 3400, 3400, 3200, 2800, 2400, 2400 , 2600, 3200, 3200, 3400, 3400, 3600, 3200, 2800, 2400, 2400 , 2600, 3200, 2300, 2300, 2403, 3200, 3100, 2900, 3400, 3400, 2600, 3200,],
                c = ["Apr 01", "Apr 02", "Apr 03", "Apr 04", "Apr 05", "Apr 06", "Apr 07", "Apr 08", "Apr 09", "Apr 10", "Apr 11", "Apr 12", "Apr 13", "Apr 14", "Apr 15" , "Apr 16", "Apr 17" , "Apr 18" , "Apr 19" ,"Apr 20" ,"Apr 21" ,"Apr 22" ,"Apr 23" ,"Apr 24" ,"Apr 25" ,"Apr 26" , "Apr 27" ,"Apr 28" ,"Apr 29" ,"Apr 30"];

                var cmdates=window.cmdate;
                var cmsales=window.cmsales;
            ...
            var u = [3200, 2100, 3200, 3200, 3500, 2400, 3250, 2400, 2400, 3250, 2400, 2800],
                p = ["Jan 2022", "Feb 2022", "Mar 2022", "Apr 2022", "May 2022", "Jun 2022", "Jul 2022", "Aug 2022", "Sep 2022", "Oct 2022", "Nov 2022", "Dec 2022"];
                var cymon=window.cymon;
               var cysales= window.cysales;

               u=cysales;
               p=cymon;
            
            o(r, "#kt_charts_widget_35_tab_5", "#kt_charts_widget_35_chart_5", u, p, !1), KTThemeMode.on("kt.thememode.change", (function() {
                e.rendered && e.self.destroy(), t.rendered && t.self.destroy(), a.rendered && a.self.destroy(), l.rendered && l.self.destroy(), r.rendered && r.self.destroy(), o(e, "#kt_charts_widget_35_tab_1", "#kt_charts_widget_35_chart_1", i, s, e.rendered), o(t, "#kt_charts_widget_35_tab_2", "#kt_charts_widget_35_chart_2", n, d, t.rendered), o(a, "#kt_charts_widget_35_tab_3", "#kt_charts_widget_35_chart_3", m, c, a.rendered), o(l, "#kt_charts_widget_35_tab_4", "#kt_charts_widget_35_chart_4", g, f, l.rendered), o(r, "#kt_charts_widget_35_tab_5", "#kt_charts_widget_35_chart_5", u, p, r.rendered)
            }))
        }
    }
}();
    ...
    return {
        init: function() {
            ...
            var u = [3200, 2100, 3200, 3200, 3200, 3500, 3e3, 2400, 3250, 2400, 2400, 3250, 3e3, 2400, 2800],
                p = ["Sep 2021", "Oct 2021", "Nov 2021", "Dec 2021", "Jan 2022", "Feb 2022", "Mar 2022", "Apr 2022", "May 2022", "Jun 2022", "Jul 2022", "Aug 2022", "Sep 2022", "Oct 2022", "Nov 2022"];
            o(r, "#kt_charts_widget_41_tab_5", "#kt_charts_widget_41_chart_5", u, p, !1), KTThemeMode.on("kt.thememode.change", (function() {
...
var KTChartsWidget8 = function() {
    var e = {
        ...
        a = function(e, t, a, l, r) {
            ...
            var myElement1 = document.getElementById('myElement25');
            var ord = myElement1.dataset.myVariable;
            ord=+ord;
            var myElement3 = document.getElementById('myElement26');
            var rev = myElement3.dataset.myVariable;
            rev=+rev;


            // var myVariable4=myVariable3/myVariable1;
            // var numbers = [myVariable1,myVariable3,myVariable4];
            // l[0]=[numbers];
            console.log(rev);
            console.log(ord);
            console.log('rahul');
            ...
            if (o) {
                var i = parseInt(KTUtil.css(o, "height")),
                    ...
                    n = {
                        series: [{
                            name: "Brand Promotions Sale",
                            data: l[0]
                        }, {
                            name: "Greeting Service Sale",
                            data: l[1]
                        }, {
                            name: "Video Chat Sale",
                            data: l[2]
                        }, {
                            name: "Shoutout Service Sale",
                            data: l[3]
                        }, {
                            name: "Influencer Acquisition Sale",
                            data: l[4]
                        }],
                        chart: {
                            fontFamily: "inherit",
                        ...
                        colors: [KTUtil.getCssVariableValue("--kt-primary"), KTUtil.getCssVariableValue("--kt-success"), KTUtil.getCssVariableValue("--kt-warning"), KTUtil.getCssVariableValue("--kt-danger"), "#43CED7"],
                        fill: {
                            opacity: 1
                        },
                        markers: {
...
var lr1=getOrdersRevenueinfoacq();
l=lr1;




var lr2=getOrdersRevenueinfoacq1();
r=lr2;
console.log("dynamic");
...
var KTTimelineWidget24 = {
    init: function() {
        ...
        (e = document.querySelector("#kt_list_widget_24")) && KTUtil.on(e, '[data-kt-element="follow"]', "click", (function(e) {
            "Following" === this.innerText ? (this.innerText = "Follow", this.classList.add("btn-light-primary"), this.classList.remove("btn-primary"), this.blur()) : (this.innerText = "Following", this.classList.add("btn-primary"), this.classList.remove("btn-light-primary"), this.blur())
        }))
    }
};
                ...
                if (e) {
                    var t, a = function() {
                        ...
                        var a = t.container.children.push(am5map.MapChart.new(t, {
                            ...
                            l = a.series.push(am5map.MapPolygonSeries.new(t, {
                        ...
                        r.mapPolygons.template.setAll({
                            ...
                            toggleKey: "active",
                            interactive: !0
                        }), am5.ColorSet.new(t, {}), r.mapPolygons.template.set("fill", am5.color(KTUtil.getCssVariableValue("--kt-primary"))), r.mapPolygons.template.states.create("hover", {
...
function getOrdersRevenueband(){
    ...
    var myElement3 = document.getElementById('myElement7');
...
function getOrdersRevenuegm(){
    ...
    var myElement3 = document.getElementById('myElement8');
    var myVariable3 = myElement3.dataset.myVariable;
    myVariable3=+myVariable3;
...
function getOrdersRevenuevc(){
    ...
    var myElement3 = document.getElementById('myElement9');
    var myVariable3 = myElement3.dataset.myVariable;
    myVariable3=+myVariable3;
...
function getOrdersRevenueshout(){
    // Implement your logic here to retrieve dynamic data for Completed Orders
    // Return the array of data for Completed Orders
    var myElement1 = document.getElementById('myElement4');
    var myVariable1 = myElement1.dataset.myVariable;
    ...
    var myElement4 = document.getElementById('myElement10');
    var myVariable4 = myElement4.dataset.myVariable;
    myVariable4=+myVariable4;


    var myElement5 = document.getElementById('myElement11');
    var myVariable5 = myElement5.dataset.myVariable;
    myVariable5=+myVariable5;

    var myvariable6=myVariable4+myVariable5;


    var myvariable7=myvariable6/myvariable3;

    var numbers = [myvariable3,myvariable6,myvariable7];
...
function getOrdersRevenueinfoacq(){
    // Implement your logic here to retrieve dynamic data for Completed Orders
    // Return the array of data for Completed Orders
    var myElement1 = document.getElementById('myElement6');
    var myVariable1 = myElement1.dataset.myVariable;
    ...
    var myElement3 = document.getElementById('myElement12');
    var myVariable3 = myElement3.dataset.myVariable;
    ...
    var brands = getOrdersRevenueband();

    var gm = getOrdersRevenuegm();

    var vc=getOrdersRevenuevc();

    var shout= getOrdersRevenueshout();
...
function getOrdersRevenueband1(){
    // Implement your logic here to retrieve dynamic data for Completed Orders
    // Return the array of data for Completed Orders
    var myElement1 = document.getElementById('myElement13');
    var myVariable1 = myElement1.dataset.myVariable;
    myVariable1=+myVariable1;

    var myElement3 = document.getElementById('myElement19');
    var myVariable3 = myElement3.dataset.myVariable;
    myVariable3=+myVariable3;
...
function getOrdersRevenuegm1(){
    // Implement your logic here to retrieve dynamic data for Completed Orders
    // Return the array of data for Completed Orders
    var myElement1 = document.getElementById('myElement14');
    var myVariable1 = myElement1.dataset.myVariable;
    myVariable1=+myVariable1;

    var myElement3 = document.getElementById('myElement20');
    var myVariable3 = myElement3.dataset.myVariable;
    myVariable3=+myVariable3;
...
function getOrdersRevenuevc1(){
    // Implement your logic here to retrieve dynamic data for Completed Orders
    // Return the array of data for Completed Orders
    var myElement1 = document.getElementById('myElement15');
    var myVariable1 = myElement1.dataset.myVariable;
    myVariable1=+myVariable1;

    var myElement3 = document.getElementById('myElement21');
    var myVariable3 = myElement3.dataset.myVariable;
    myVariable3=+myVariable3;
...
function getOrdersRevenueshout1(){
    // Implement your logic here to retrieve dynamic data for Completed Orders
    // Return the array of data for Completed Orders
    var myElement1 = document.getElementById('myElement16');
    var myVariable1 = myElement1.dataset.myVariable;
    myVariable1=+myVariable1;

    var myElement2 = document.getElementById('myElement17');
    var myVariable2 = myElement2.dataset.myVariable;
    myVariable2=+myVariable2;
    ...
    var myElement4 = document.getElementById('myElement22');
    var myVariable4 = myElement4.dataset.myVariable;
    myVariable4=+myVariable4;


    var myElement5 = document.getElementById('myElement23');
    var myVariable5 = myElement5.dataset.myVariable;
    myVariable5=+myVariable5;
...
function getOrdersRevenueinfoacq1(){
    // Implement your logic here to retrieve dynamic data for Completed Orders
    // Return the array of data for Completed Orders
    var myElement1 = document.getElementById('myElement18');
    var myVariable1 = myElement1.dataset.myVariable;

    myVariable1=+myVariable1;


    var myElement3 = document.getElementById('myElement24');
    var myVariable3 = myElement3.dataset.myVariable;
    ...
    var brands = getOrdersRevenueband1();

    var gm = getOrdersRevenuegm1();

    var vc=getOrdersRevenuevc1();

    var shout= getOrdersRevenueshout1();
...
var KTPlayersWidget1 = {
    init: function() {
        KTUtil.on(document.body, '[data-kt-element="list-play-button"]', "click", (function(e) {
            ...
            r.classList.contains("d-none") ? (a.play(), l.classList.add("d-none"), r.classList.remove("d-none")) : (a.pause(), l.classList.remove("d-none"), r.classList.add("d-none")), [].slice.call(document.querySelectorAll('[data-kt-element="list-play-button"]')).map((function(e) {
                if (e !== t) {
    ...
    return {
        init: function() {
            ...
            r && (r.addEventListener("slid.bs.carousel", (function(e) {
                ...
                e.rendered && (e.self.destroy(), e.rendered = !1), t.rendered && (t.self.destroy(), t.rendered = !1), a.rendered && (a.self.destroy(), a.rendered = !1), l(e, "#kt_slider_widget_1_chart_1", 76), l(t, "#kt_slider_widget_1_chart_2", 55), l(a, "#kt_slider_widget_1_chart_3", 25)
            })))
        }
    }
}();
    ...
    return {
        init: function() {
            ...
            r && (r.addEventListener("slid.bs.carousel", (function(e) {
                ...
                e.rendered && (e.self.destroy(), e.rendered = !1), t.rendered && (t.self.destroy(), t.rendered = !1), a.rendered && (a.self.destroy(), a.rendered = !1), l(e, "#kt_slider_widget_7_chart_1", 76), l(t, "#kt_slider_widget_7_chart_2", 55), l(a, "#kt_slider_widget_7_chart_3", 25)
            })))
        }
    }
}();
...
var KTTablesWidget15 = function() {
    var e = {
        ...
        l = {// var KTTablesWidget14 = function() {
            //     var e = {
            //             self: null,
            //             rendered: !1
            //         },
    ...
    return {
        init: function() {
            ...
            o(r, "#kt_table_widget_15_chart_5", m, !0), KTThemeMode.on("kt.thememode.change", (function() {
                e.rendered && e.self.destroy(), t.rendered && t.self.destroy(), a.rendered && a.self.destroy(), l.rendered && l.self.destroy(), r.rendered && r.self.destroy(), o(e, "#kt_table_widget_15_chart_1", i, e.rendered), o(t, "#kt_table_widget_15_chart_2", s, t.rendered), o(a, "#kt_table_widget_15_chart_3", n, a.rendered), o(l, "#kt_table_widget_15_chart_4", d, l.rendered), o(r, "#kt_table_widget_15_chart_5", m, r.rendered)
            }))
        }
    }
}();
    ...
    const l = () => {
        ...
        i = (t, l) => {
            t.forEach(((r, o) => {
                ...
                s.setAttribute("src", u + r.image + ".gif"), n.innerText = r.name, d.innerText = r.description, m.innerText = r.cost, c.innerText = r.qty, g.innerText = r.total, r.stock > 10 ? f.innerHTML = '<div class="badge badge-light-success">In Stock</div>' : f.innerHTML = '<div class="badge badge-light-warning">Low Stock</div>', 1 === t.length || t.length;
