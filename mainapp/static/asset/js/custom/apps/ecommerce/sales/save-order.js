    ...
    return {
        init: function() {
            (() => {
                ...
                $("#kt_ecommerce_edit_order_date2").flatpickr({
                    altInput: !0,
                    altFormat: "d F, Y",
                    dateFormat: "Y-m-d"
                });
                ...
                $("#kt_ecommerce_edit_order_billing_country").select2({
                    ...
                    templateSelection: r,
                    templateResult: r
                }), e = document.querySelector("#kt_ecommerce_edit_order_product_table"), t = $(e).DataTable({
                    order: [],
                    scrollY: "680px",
                    scrollCollapse: !0,
                    paging: !1,
                ...
                const d = () => {
                        ...
                        t.length < 1 ? (e.classList.remove("d-none"), o.innerText = "0.00") : (e.classList.add("d-none"), i(t))
                    },
                    i = e => {
                        let t = 0;
                        e.forEach((e => {
                ...
                e = FormValidation.formValidation(t, {
                    ...
                    o.preventDefault(), e && e.validate().then((function(e) {
                        console.log("validated!"), "Valid" == e ? (r.setAttribute("data-kt-indicator", "on"), r.disabled = !0, setTimeout((function() {
                            r.removeAttribute("data-kt-indicator"), Swal.fire({
