...
var KTWidgets = {
    init: function() {
        ...
        ! function() {
            ...
            function() {
                var e = document.getElementById("kt_charts_widget_55_chart");
                if (e) {
                    var t = {
                            self: null,
                            rendered: !1
...
function getOrdersCost(){
    // Implement your logic here to retrieve dynamic data for Completed Orders
    // Return the array of data for Completed Orders
    var cost = window.cost;
    return  cost;
...
function getreveneve1(){
    // Implement your logic here to retrieve dynamic data for Completed Orders
    // Return the array of data for Completed Orders
    var revenue1 = window.revenue1;
    return  revenue1;
...
function getexpense(){
    // Implement your logic here to retrieve dynamic data for Completed Orders
    // Return the array of data for Completed Orders
    var expense = window.expense;
    return  expense;
    
}

function getmax_revenue(){
    // Implement your logic here to retrieve dynamic data for Completed Orders
    // Return the array of data for Completed Orders
    var max_revenue = window.max_revenue;
    return  max_revenue;
